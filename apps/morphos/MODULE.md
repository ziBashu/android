...
| **1.2.5 Hit** | Live Smart Island stacked above the Morph shade pull so tap/expand/transport work |
| **1.2.6 Island** | Media detection (NLS ongoing + audio + playing sessions); compact auto-shrink capsule |
| **1.2.7 Island** | No overlay on OEM Magic Capsule; generic Now playing stays compact; Brave/YouTube titles from notifications |
...
- [x] Warehub upload **v1.2.7** — https://zibashu4.com/hub/warehub/morphos
- [x] Dual signed release (upload keystore): warehub APK + Play AAB in `dist/`
- [ ] Play Console upload (AAB ready at `dist/morphos-v1.2.7-play.aab`; Internal track when requested)
