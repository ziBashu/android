...
List<MorphPack> kBuiltInMorphStore() {
  return const [
    ...
    MorphPack(
      ...
      name: 'Zen Study',
      author: 'ziBashu',
      description: 'Study Space — books, dictionary, timer, quiet focus.',
      category: 'mode',
      ...
      targetProfile: MorphProfileId.study,
      showLabels: true,
      iconScale: 1.0,
      gridColumns: 3,
      dockIds: ['notes', 'reader', 'timer', 'dictionary', 'settings'],
      homeIds: ['notes', 'reader', 'dictionary', 'timer', 'browser', 'clock'],
      quietMode: true,
      tags: ['study', 'focus', 'school'],
      builtIn: true,
    ),
    MorphPack(
      id: 'store.wanderlust',
      name: 'Wanderlust',
      author: 'ziBashu',
      description: 'Travel Space — map, translate, camera, currency.',
      category: 'mode',
      ...
      targetProfile: MorphProfileId.travel,
      showLabels: true,
      iconScale: 1.15,
      gridColumns: 3,
      ...
      largeTargets: true,
      tags: ['travel', 'map', 'translate'],
      builtIn: true,
    ),
    MorphPack(
      id: 'store.forest_reader',
      name: 'Forest Reader',
      author: 'ziBashu',
      description: 'Book reader mode — warm, minimal, eye comfort.',
      category: 'mode',
      ...
      homeIds: ['notes', 'browser', 'clock', 'music', 'reader'],
      quietMode: true,
      tags: ['reading', 'quiet', 'books'],
      builtIn: true,
    ),
    MorphPack(
