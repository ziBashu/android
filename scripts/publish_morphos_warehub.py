...
APK_LOCAL = ANDROID_ROOT / "dist" / "morphos-v1.2.7-warehub.apk"
AAB_LOCAL = ANDROID_ROOT / "dist" / "morphos-v1.2.7-play.aab"
ICON_LOCAL = (
...
def main() -> None:
    ...
    payload = {
        ...
        "platforms": platforms,
        "changelog": (
            f"v{VERSION_NAME}: Smart Island detects playing media, peeks then auto-shrinks "
            "to a compact capsule, and no longer drops ongoing/media notifications."
        ),
